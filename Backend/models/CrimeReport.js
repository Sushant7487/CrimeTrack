...
//     // =================================================
//     // ✅ NEW FIELDS ADDED FOR FACE RECOGNITION FEATURE
//     // =================================================
//     suspectFaceDescriptor: { 
//         type: [Number], // Stores the mathematical representation of the face
//         default: [] 
//     },
//     matchedCaseId: { 
//         type: String, // Stores ID of previous case if a match is found
//         default: null 
//     },
//     // =================================================
...
const crimeReportSchema = mongoose.Schema(
  {
    ...
    // ✅ CHANGE: Added Linked Cases Array for History
    linkedCases: [{ 
